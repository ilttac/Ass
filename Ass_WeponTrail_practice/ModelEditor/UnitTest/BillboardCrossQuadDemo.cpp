...
void BillboardCrossQuadDemo::Initialize()
{
...
void BillboardCrossQuadDemo::Destroy()
{
	SafeDelete(shader);	
	SafeDelete(shadow);
...
void BillboardCrossQuadDemo::Update()
{
...
void BillboardCrossQuadDemo::PreRender()
{
	sky->PreRender();
...
void BillboardCrossQuadDemo::Render()
{
	sky->Pass(4, 5, 6);
	sky->Render();
...
void BillboardCrossQuadDemo::PostRender()
{
	//gBuffer->DebugRender();
	//sky->PostRender();
}

void BillboardCrossQuadDemo::Mesh()
{
	//Create Material
	{
		//¹Ù´Ú
...
void BillboardCrossQuadDemo::Airplane()
{
...
void BillboardCrossQuadDemo::Kachujin()
{
	weapon = new Model();
...
void BillboardCrossQuadDemo::Pass(UINT mesh, UINT model, UINT anim)
{
...
void BillboardCrossQuadDemo::AddPointLights()
{
	PointLight light;	
...
void BillboardCrossQuadDemo::AddSpotLights()
{
	SpotLight light;
	light =
	{
...
void BillboardCrossQuadDemo::AddBillboard()
{
